                        ...
                        <Paper sx={{ p: 2, borderRadius: 2, backgroundColor: '#FEF2EA' }}>
                            <Grid spacing={2}>
                                ...
                                <Grid item xs={6} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                    ...
                                    <Typography variant="h5">COW-{mechanic.id}</Typography>
                                </Grid>
                                ...
                                <Grid item xs={6} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mt: 2 ,}}>
                                    ...
                                    <Typography variant="h4" sx={{width:'40%'}}>Toyota Corolla 2015 — ABJ-231XZ, Lexus RX350 2020 — LAG-453AB, </Typography>
                                </Grid>



                                <Grid item xs={6} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mt: 2 }}>
                                    <Typography variant="h4" fontWeight={700}>Complains : </Typography>
                                    <Typography variant="h4">6</Typography>
                                </Grid>


                                 <Grid item xs={6} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mt: 2 }}>
                                    <Typography variant="h4" fontWeight={700}>VIN : </Typography>
                                    <Typography variant="h4">2T1BURHE0GC123456</Typography>
                                </Grid>
                            </Grid>
                        </Paper>
                    </Grid>
