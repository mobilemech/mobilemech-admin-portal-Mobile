...
const image =
  "https://images.unsplash.com/photo-1531891437562-4301cf35b7e4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8aGFuZHNvbWV8ZW58MHx8MHx8fDA%3D";

export default function ComplaintDetailsModal({ open, onClose, complaint }) {
  const [statusFilter, setStatusFilter] = useState("Mutual/ No Action");
  const STATUS_OPTIONS = ["Mutual/ No Action", "Mechanic", "Car Owner"];
  ...
  return (
    <Modal open={open} onClose={onClose}>
      ...
      >
        ...
        <Typography variant="h4" mt={5} fontWeight={700}>
          Photos/Proof
        </Typography>
        ...
        <Box sx={{ mt: 7 }}>
          ...
          <Typography variant="h5" mt={4} fontWeight={500}>
            Resolve in Favout of
          </Typography>
          <Select
            fullWidth
            size="small"
          ...
          >
            <MenuItem value="Mutual/ No Acton">Select One</MenuItem>
